...
let getESSValue = (() => {
  ...
  return function getESSValue(_x, _x2) {
...
let getEC2Value = (() => {
  ...
  return function getEC2Value(_x3, _x4) {
...
let getVPCValue = (() => {
  ...
  return function getVPCValue(_x5, _x6) {
...
let getSubnetValue = (() => {
  ...
  return function getSubnetValue(_x7, _x8) {
...
let getKinesisValue = (() => {
  ...
  return function getKinesisValue(_x9, _x10) {
...
let getDynamoDbValue = (() => {
  ...
  return function getDynamoDbValue(_x11, _x12) {
...
let getRDSValue = (() => {
  ...
  return function getRDSValue(_x13, _x14) {
 ...
 */
let getValueFromAws = (() => {
  var _ref8 = (0, _asyncToGenerator3.default)(function* (variableString, region, strictMode) {
  ...
  return function getValueFromAws(_x15, _x16, _x17) {
